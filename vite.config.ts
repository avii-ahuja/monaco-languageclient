        ...
        build: {
            ...
            rollupOptions: {
                input: {
                    client: path.resolve(
                        __dirname,
                        "packages/examples/client.html"
                    ),
                    statemachineClient: path.resolve(
                        __dirname,
                        "packages/examples/statemachine_client.html"
                    ),
                        ...
                        setup({ onLoad }) {
                            ...
                            onLoad(
                                ...
                                async (args) => {
                                    ...
                                    for (
                                        let match =
                                            assetImportMetaUrlRE.exec(code);
                                        match != null;
